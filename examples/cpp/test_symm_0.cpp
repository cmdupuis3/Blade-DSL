...
static constexpr const size_t res_symm[7]={1,2,3,4,5,6,7};




static constexpr const size_t a1_symm[7] = {1,  2,  3,  4,  5,  6,  7};
...
template<> void add10<float, 7, a1_symm, float, 7, res_symm>(
	...
	for(__i0 = 0; __i0 < in1_extents[0] - 0; __i0++) {
		...
		for(__i1 = 0; __i1 < in1_extents[1] - 0; __i1++) {
			promote<float, 5>::type in1__i1 = in1__i0[__i1];
			size_t __i2 = 0;
			
			for(__i2 = 0; __i2 < in1_extents[2] - 0; __i2++) {
				promote<float, 4>::type in1__i2 = in1__i1[__i2];
				size_t __i3 = 0;
				
				for(__i3 = 0; __i3 < in1_extents[3] - 0; __i3++) {

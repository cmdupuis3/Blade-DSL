...
static constexpr const size_t res_symm[8]={1,1,1,1,2,3,4,5};
...
start=TIME;
add10<float,1,nullptr,float,1,nullptr,float,1,nullptr,float,1,nullptr,float,1,nullptr,float,1,nullptr,float,1,nullptr,float,1,nullptr,float,8,res_symm>(a1,a1,a1,a1,a5,a6,a7,a8,res,extents1,extents1,extents1,extents1,extents1,extents1,extents1,extents1,extents0_res);
end=TIME;
diff=1e-9*TIME_DIFF;
